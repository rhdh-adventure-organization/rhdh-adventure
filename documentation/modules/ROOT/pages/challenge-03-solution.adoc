...
More information about Dynamic Plugins https://docs.redhat.com/en/documentation/red_hat_developer_hub/1.8/html-single/introduction_to_plugins/index[here].
