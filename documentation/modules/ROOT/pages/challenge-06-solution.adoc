...
Enabling or disabling dynamic plugins is based in the link:https://github.com/backstage/backstage/tree/master/packages/backend-dynamic-feature-service[backend plugin manger]
...
https://github.com/piatkiewicz/backstage-plugins/tree/main/dev-friends-days

Not it is time to install:

By Operator:

add the definition into the rhdh-dynamics-pluigin - github|gitlab
