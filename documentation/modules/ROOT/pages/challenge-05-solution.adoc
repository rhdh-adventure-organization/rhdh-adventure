...
Software Template url: `https://github.com/rhdh-adventure-organization/node-template-gl/blob/main/template.yaml/template.yaml`
--
====
...
----
oc apply -f ./documentation/modules/ROOT/examples/challenge-05/rhdh-app-config-cm-github.yaml
----
...
[source, bash, subs="+macros,+attributes"]
----
oc apply -f ./documentation/modules/ROOT/examples/challenge-05/rhdh-app-config-cm-gitlab.yaml
----
