...
----
NAME                   DISPLAY                          VERSION   REPLACES               PHASE
rhdh-operator.v1.4.0   Red Hat Developer Hub Operator   1.4.0     rhdh-operator.v1.3.3   Succeeded
----
...
----
NAME                                DISPLAY    VERSION   REPLACES                            PHASE
gitlab-operator-kubernetes.v1.9.0   GitLab     1.9.0     gitlab-operator-kubernetes.v1.8.3   Succeeded
----
...
----
NAME                   DISPLAY          VERSION   REPLACES               PHASE
web-terminal.v1.11.0   Web Terminal     1.11.0    web-terminal.v1.10.1   Succeeded
----
