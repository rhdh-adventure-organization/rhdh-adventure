...
----
NAME                   DISPLAY                          VERSION   REPLACES               PHASE
rhdh-operator.v1.4.2   Red Hat Developer Hub Operator   1.4.2     rhdh-operator.v1.4.1   Succeeded
----
...
----
NAME                             DISPLAY         VERSION   REPLACES                         PHASE
gitlab-runner-operator.v1.34.0   GitLab Runner   1.34.0    gitlab-runner-operator.v1.32.0   Succeeded
----
...
----
NAME                   DISPLAY          VERSION   REPLACES               PHASE
web-terminal.v1.11.1   Web Terminal     1.11.1    web-terminal.v1.11.0   Succeeded
----
